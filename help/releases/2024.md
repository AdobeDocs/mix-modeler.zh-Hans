...
| **字段级访问控制** | 定义数据集规则时，在[字段级](https://experienceleague.adobe.com/en/docs/experience-platform/access-control/abac/overview)上强制实施Experience Platform基于[属性的访问控制](../harmonize-data/dataset-rules.md#field-level-access-control)。 | 2024年6月12日 |
