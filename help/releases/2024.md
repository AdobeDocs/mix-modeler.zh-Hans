...
| 功能 | 描述 | 正式发布 |
|---|---|---|
| **计划培训和评分** | 您可以在[构建模型](/help/models/build.md#schedule)时以及从[模型insight](/help/models/insights.md#edit)或模型[的](/help/models/overview.md#edit)上下文菜单编辑模型时，计划模型的训练和评分。 | 2024年10月21日 |
...
| **字段级访问控制** | 定义数据集规则时，在[字段级](https://experienceleague.adobe.com/zh-hans/docs/experience-platform/access-control/abac/overview)上强制实施Experience Platform基于[属性的访问控制](../harmonize-data/dataset-rules.md#field-level-access-control)。 | 2024年6月12日 |
