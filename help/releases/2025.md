---
title: 查看2025 Mix Modeler发行说明
description: 查看2025 Mix Modeler发行说明
...
|---|---|---|---|
| **[!UICONTROL Plans tracking]** | 允许用户了解营销计划的执行如何跟踪计划的内容。 这样您就可以对营销效果充满信心。 或者尽早发现机会和风险，以纠正错误并实现业务目标。 已更新[计划可视化图表的性能](/help/dashboard/plans.md#performance-to-plan)，并允许配置量度和粒度。 | 2025 年 11 月 12 日 | 2025 年 11 月 12 日 |
| **[!UICONTROL Channel synergy insights]** | 展示营销渠道如何协作以产生更大的影响。 通过这些见解，您可以满怀信心地解释过去的营销绩效并相应地调整营销支出，以最大限度地提高营销投资组合的整体回报。 [模型分析](/help/models/insights.md#channel-synergy)和[计划分析](/help/plans/insights.md#channel-synergies)中提供了渠道协同矩阵。 | 2025 年 11 月 12 日 | 2025 年 11 月 12 日 |
| **修复** | 修复了以下票证： <ul><li>AMM-2920：计划创建流程和迁移。</li><li>AMM-3282：大网格中小数字变化的科学记数法。</li></ul> | 2025 年 11 月 12 日 | 2025 年 11 月 12 日 |
...
| **修复** | 修复了以下票证： <ul><li>AMM-3101：修复了为规则创建不正确的映射： `event_date`作为字段名称而非`timestamp`传递。</li><li>AMM-3092：修复了无法更改基于重复预算的计划的渠道最大限制值。</li><li>AM3130：修复了模型的详细信息弹出窗口中错误的&#x200B;**[!UICONTROL Run frequency]**&#x200B;信息。</li><li>AMM3158：在[计划创建](/help/plans/build.md)接口的&#x200B;**[!UICONTROL Optimize]**&#x200B;窗格中更新了&#x200B;**[!UICONTROL Select target metric]**&#x200B;选项的标签。</li><li>AMM 3176：修复了无法在&#x200B;**[!UICONTROL Model Insights]**&#x200B;的&#x200B;**[!UICONTROL Attribution]**&#x200B;选项卡中查看[按渠道](/help/models/insights.md#breakdown)划分可视化图表的问题。</li></ul> | 2025年9月9日 | 2025年9月9日 |
