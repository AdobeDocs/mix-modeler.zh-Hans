...
**[!UICONTROL Plans]** [!BADGE Beta]{type=Informative}选项卡显示：

* [KPI状态卡](#kpi-status-cards)：
...
要调整可视化图表的大小，请使用右下角的┛句柄。 要移动可视化图表，只需将该可视化图表拖放到首选位置。

您可以将鼠标悬停在可视化图表中任意线条、条形或散点元素上，以显示包含其他信息的弹出窗口。

![可视化图表](../assets/performance-to-plan-visualizations.png)

### *量度*：实际与计划

栈叠条形图可视化图表，用于比较迄今、迄今计划和总计的选定指标值。


### *量度*：实际粒度与按&#x200B;*粒度计划的粒度*

显示选定量度和选定粒度的实际值和计划值的折线图可视化图表。


### 渠道&#x200B;*指标*&#x200B;乘以&#x200B;*粒度*

一种栈叠条形图可视化图表，它显示栈叠的条形图，这些条形图显示选定量度和选定粒度的渠道。
...
1. 选择![编辑](/help/assets/icons/Edit.svg)以打开&#x200B;**[!UICONTROL Edit data]**&#x200B;对话框。
1. 根据可视化图表，您可以更改：

   * 一个或两个量度：从&#x200B;**[!UICONTROL Select metric]**&#x200B;下拉菜单中选择一个量度。
...
1. 选择&#x200B;**[!UICONTROL Apply]**&#x200B;以应用更改。 选择&#x200B;**[!UICONTROL Cancel]**&#x200B;以取消对可视化图表的任何更改。
