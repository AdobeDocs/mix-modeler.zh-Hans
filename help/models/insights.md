...
要查看模型分析，请在[!DNL Mix Modeler]的![模型](/help/assets/icons/FileData.svg) **[!UICONTROL Models]**&#x200B;界面中：
...
**[!UICONTROL Model insights]**&#x200B;选项卡显示[按日期和基本媒体列出的贡献](#contribution-by-date-and-base-media)、[按渠道列出的贡献](#contribution-by-channel)、[营销绩效摘要](#marketing-performance-summary)和[边际响应曲线](#marginal-response-curves)的可视化图表。 该选项卡还提供[接触点细分](#touchpoint-breakdown)表。
...
* 要以® Excel格式下载完整的模型分析数据，请选择![下载](/help/assets/icons/Download.svg) **[!UICONTROL Download data]**。
...
**[!UICONTROL Channel analysis]**&#x200B;选项卡显示&#x200B;**[!UICONTROL Channel synergies]**&#x200B;和&#x200B;**[渠道adstock]**&#x200B;的可视化图表。


### 渠道协同效应

渠道协同可视化图表可帮助您识别营销渠道如何进行交互，以便在各自贡献之外产生乘数效应。
...
![计划渠道协同效应](/help/assets/model-channel-synergies-less.png)

>[!TAB 显示所有协同效应]

![计划渠道协同效应](/help/assets/model-channel-synergies-all.png)

>[!ENDTABS]


* 要显示所有协同作用，请选择&#x200B;**[!UICONTROL Show all]**。

* 要选择更少的协同效应，请选择&#x200B;**[!UICONTROL Show less]**

* 要显示协同的详细信息，请将鼠标悬停在可视化图表的单元格上。
...
每个图表表示一个营销渠道，并显示其Adstock曲线。 该曲线模拟了一个单位曝光量的影响如何延续到未来期间。 该曲线说明了对转化影响减小的速率，并帮助营销人员比较不同渠道在初始投资后对绩效持续影响的时间。

衰减曲线较慢（尾部较长）的通道指示随时间持续的影响。 股价暴跌的渠道反映的是更为直接的短期影响。 为该渠道配置的最大回顾时间决定了每条曲线的长度。

>[!BEGINTABS]

>[!TAB 显示所有adstock]

![计划渠道协同效应](/help/assets/model-channel-adstock-all.png)

>[!TAB 显示选定的adstock]

![计划渠道协同效应](/help/assets/model-channel-adstock-selected.png)

>[!ENDTABS]

* 要显示&#x200B;**[!UICONTROL All channels]**&#x200B;的Adstock可视化图表或单个渠道（例如，**[!UICONTROL Paid Social Facebook]**）的Adstock可视化图表，请从&#x200B;**[!UICONTROL Channel]**&#x200B;下拉菜单中选择。
...
Mix Modeler多点接触归因粒度事件分数与总体[!DNL Mix Modeler]分数和ROI一致。 这些得分也可作为Experience Platform中的数据集使用。
...
展开的&#x200B;**[!UICONTROL Top campaigns]**&#x200B;对话框显示的表具有下列的附加列：
...
>title="模型日期截至"
>abstract="此表的数据仅为特定时间段生成。  **[!UICONTROL As of]**&#x200B;日期指示生成数据的时间，并且以从指定日期起直到前一年期间的数据为基础。"
...
>[!AVAILABILITY]
>
>此部分中描述的功能处于版本的有限测试阶段，可能尚未在您的环境中可用。 当功能正式可用时，将删除此注释。 有关[!DNL Mix Modeler]发布过程的信息，请参阅[Mix Modeler功能发布](/help/releases/latest.md)。
>
