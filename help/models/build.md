...
1. 要为模型定义回看窗口期，请在`1`部分的`52` ... **[!UICONTROL Give contribution credit to touchpoints occurring within]**&#x200B;中输入一个介于&#x200B;**[!UICONTROL weeks prior to the conversion]**&#x200B;和&#x200B;**[!UICONTROL Define lookback window]**&#x200B;之间的值。
