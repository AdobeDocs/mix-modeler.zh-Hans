...
如果您用于计划的模型是在新数据上得分的，则需要创建新计划以考虑重新得分的数据。
...
1. 您会看到当前计划及其状态的表。
   ...
   | 列名 | 详细信息 |
   |---|---|
   | **[!UICONTROL Name]** | 计划的名称 |
   | **[!UICONTROL Model]** | 用作计划基础的模型。 |
   | **[!UICONTROL Date range]** | 计划的完整日期范围。 |
   | **[!UICONTROL Budget]** | 计划的总预算。 |
   | **[!UICONTROL Plan target]** | 为基于目标的计划定义的目标量度。 |
   | **[!UICONTROL Forecasted return]** | 计划的[预测返回](/help/main-guide/glossary.md) |
   | **[!UICONTROL Forecasted ROI]** | 计划的[预测ROI](/help/main-guide/glossary.md)。 |
   | **[!UICONTROL Forecasted conversion]** | 计划的[预测转化](/help/main-guide/glossary.md) |
   | **[!UICONTROL Forecasted CPA]** | 计划的[预测CPA](/help/main-guide/glossary.md) |
   | **[!UICONTROL Status]** | 计划的状态：<br/>![StatusOrange](/help/assets/icons/StatusOrange.svg) **[!UICONTROL Failed]**、<br/>![StatusBlue](/help/assets/icons/StatusBlue.svg) **[!UICONTROL Processing]**&#x200B;或<br/>![StatusGreen](/help/assets/icons/StatusGreen.svg) **[!UICONTROL Complete]**。 |
